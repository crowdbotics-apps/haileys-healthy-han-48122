"""
Django settings for haileys_healthy_han_48122 project.
...
ROOT_URLCONF = 'haileys_healthy_han_48122.urls'
...
WSGI_APPLICATION = 'haileys_healthy_han_48122.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "haileys_healthy_han_48122 API",
    "DESCRIPTION": "API documentation for haileys_healthy_han_48122 App",
    "VERSION": "v1",
}
